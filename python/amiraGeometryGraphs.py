...
class SptGr:
  ...
  def __init__(self, amiraFileName):
    ...
    self.sections = {} # main repository of points
    self.secRads = {} # main repository of rads
    self.graphEndpoints = {} # a dict of which endpoints are part of
                             # each graph
    slef.graphEndpointsList = [] # used to generate dict graphEndpoints
    self.getGraphEndpoints = False 
    self.graphSecs = []
    self.graphs = {} # a dict of which segs are in each graph
    ...
    with open(self.inFile, 'r') as fIn:
      ...
      for line in fIn:
        ...
        if splitLine:
          ...
          elif self.getGraphEndpoints == True:
            self.graphEndpointsList.append(int(splitLine[0]))
          ...
          elif self.getGraphs == True:
            self.graphSecs.append(int(splitLine[0]))
  ...
  def createGraph(self):
    """
    Creates a single graph from many making interpolating connections
    at endpoints only. 
    """
