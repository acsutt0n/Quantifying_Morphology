...
def demoRead(geoFile, passiveFile="", display=True, makePlots=False):
  ...
  properties = geometry.getProperties(passiveFile, display=display,
                                makePlots=makePlots)

  segs = [segment.nodes for segment in geometry.segments]
  print (segs)
  
  #print len(midcoords), len(endcoords)
  #midcoords, endcoords = [], []
  #for segment in geometry.segments:
  #  midcoords.append(segment.coordAt(0.5))
  #  endcoords.append(segment.coordAt(1))
